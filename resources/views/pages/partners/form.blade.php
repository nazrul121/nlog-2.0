                        ...
                        <div class="card-body pt-3">
                            <div class="theme-form">
                                <div class="form-group">
                                    <label class="col-form-label pt-0">partner Name</label>
                                    <input type="text" class="form-control" name="name" placeholder="full name" value="{{old('name')??$partner->name}}">
                                    <small class="form-text text-danger">{{ $errors->first('name')}}</small>
                                </div>

                                <div class="form-group">
                                    <label class="col-form-label pt-0">Company Name</label>
                                    <input type="text" class="form-control" name="company" placeholder="company" value="{{old('company')??$partner->company}}">
                                    <small class="form-text text-danger">{{ $errors->first('company')}}</small>
                                </div>
                               
                                <div class="form-group">
                                    <label class="col-form-label pt-0">Phone / Mobile No.</label>
                                    <input type="text" class="form-control" name="phone" placeholder="phone" value="{{old('phone')??$partner->phone}}">
                                    <small class="form-text text-danger">{{ $errors->first('phone')}}</small>
                                </div>

                                <div class="form-group">
                                    <label class="col-form-label pt-0">Email address</label>
                                    <input type="email" class="form-control" name="email" placeholder="Enter email" value="{{old('email')??$partner->email}}">
                                    <small class="form-text text-danger">{{ $errors->first('email')}}</small>
                                </div>

                                <div class="form-group">
                                    <label class="col-form-label pt-0">Office Address</label>
                                    <textarea rows="3" class="form-control" name="address" placeholder="address">{{old('address')??$partner->address}}</textarea>
                ...
                <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body pt-3"> 
                            ...
                            <div class="form-group">
                                <label class="col-form-label pt-0">Partner Photo - [optional]-[size should be: <code>320x290</code>px]</label>
                                <input type="file" class="dropify" data-height="160" name="photo" 
                                @if($partner->photo) data-default-file="/{{$partner->photo}}" @endif>
                            ...
                            <div class="form-group">
                                ...
                                @if($partner->logo) data-default-file="/{{$partner->logo}}" @endif>
                            ...
                            <div class="col text-right">
                                <div class="form-group m-t-15 m-checkbox-inline mb-0 custom-radio-ml">
                                    ...
                                    <div class="radio radio-primary">
                                        <input type="radio" name="status" id="status1" value="1" required="" @if($partner->status=='1') checked @endif>
                                        <label for="status1" class="mb-0">Active</label>
                                    </div>
                                    <div class="radio radio-primary">
                                        <input type="radio" name="status" id="status2" value="0" required="" @if($partner->status=='0') checked @endif>
