...
@section('title','Edit '.$sociel_media->media_name)
@section('content')
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <ol class="breadcrumb pull-right">
                    ...
                    <li class="breadcrumb-item active">Edit {{$sociel_media->media_name}}</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-xl-12 col-md-12 col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <span>Edit <b>{{$sociel_media->media_name}}</b></span>
                ...
                <div class="card-footer text-right mb-3">
                    <button type="submit" class="btn btn-success m-r-15"><i class="fa fa-edit"></i> Update media info</button>  
                </div>
                </form>
            </div>
        </div>
...
<script>
  $(function () {
    $('.fa').on('click',function(){
        ...
        $('.setIcon').removeClass("{{explode(' ',$sociel_media->media_icon)[1]}}");
    })
  })
</script>
@endsection
