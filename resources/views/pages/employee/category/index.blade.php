...
@section('title','Employees categories')
@section('content')
                    ...
                    <ul class="nav-menus pull-right text-right">
                        <li class="onhover-dropdown">
                            ...
                            <ul class="onhover-show-div p-20" style="top:20px;position:relative; margin-bottom: -90px;">
                                ...
                                <li><a href="{{url('/access/employee/employee-table')}}">  <i class="icon-user"></i> View Employees  </a> </li>
                            </ul>
                        </li>
                    </ul>
                   </span>
            ...
            <div class="modal-body">
                <div class="card add">
                    ...
                    <div class="card-footer mb-3">
                        <button type="submit" class="btn btn-primary pull-right"><i class="fa fa-check"></i> Save Category</button>
                    </div>
                    </form>
                </div>
...
<script type="text/javascript">
    $(function(){
        @if(Session::has('create_category')) $('#createCat').modal('show'); @endif
    })
</script>
@endsection